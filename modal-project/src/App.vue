            ...
            <div class="col-md-8 mt-5">
                <div class="card">
                    <div class="card-header">
                     ...
                     <div class="card-body"> 
                       ...
                       İsim-Soyisim <input type="text" size="20" v-model="name" placeholder="İsim Giriniz.." class="form-control"> <br> <br>
                        Şifre:  <input type="password" size="20" v-model="sıfre" placeholder="Şifre Giriniz..." class="form-control"> <br> <br>
                    ...
                    <div class="card-body">
                        ...
                        <table :key="todo.id" v-for="todo in todos">   
                     ...
                     <tr>
                        ...
                        <button @click="deleteTodo(todo.id)"> DELETE</button> 
                           <button @click="editTodo(todo)">EDİT</button> <br>
                    </tr>
                          </tbody>
